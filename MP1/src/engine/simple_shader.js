...
class SimpleShader {
    ...
    constructor(vertexShaderPath, fragmentShaderPath) {
        ...
        this.mOffsetRef = gl.getUniformLocation(this.mCompiledShader, "uOffset");
        this.mScaleRef = gl.getUniformLocation(this.mCompiledShader, "uScale");
    }

    
    // Activate the shader for rendering
    activate(pixelColor, offset, scale) {
        let gl = core.getGL();
        ...
        gl.uniform2fv(this.mOffsetRef, offset);
        gl.uniform2fv(this.mScaleRef, scale);
    }
}
